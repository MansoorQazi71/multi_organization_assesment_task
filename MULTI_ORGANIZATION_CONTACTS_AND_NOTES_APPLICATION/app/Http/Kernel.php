...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // Custom middleware: sets the current organization in session
    ...
    protected $routeMiddleware = [
        ...
        // Alias for custom organization middleware
        'set.current.organization' => \App\Http\Middleware\SetCurrentOrganization::class,
    ];
}
